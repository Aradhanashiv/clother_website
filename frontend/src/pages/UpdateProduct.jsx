  ...
  const handleImage = async (e) => {
   ...
   useEffect(()=>{
    if(!currentProduct) return
      ...
      setCategory(currentProduct.category.categoryName);
         ...
         <h1 className={`text-4xl font-bold text-pink-500 mb-2 text-center`}>Admin Panel</h1>
          <p className='text-center mt-3 font-semibold mb-6 text-gray-700'>Add Products</p>
            ...
            placeholder='Enter Product Name' required value={productName}  onChange={(e)=>setProductName(e.target.value)}/>
              ...
              <input type='file' multiple name='productImage' className='w-full border border-pink-600 rounded-xl px-3 py-2' 
            ...
            <label htmlFor="category" className='block text-gray-700 font-medium mb-1'>Product Category</label>
             ...
             <p className="border border-pink-600 py-2 px-1 mt-3 ">{category}</p>
             </div>
            ...
            {/* <div className='mb-3'>  
            <label htmlFor="stock" className='block text-gray-700 font-medium mb-1'>Product stock</label>
            <input type='number' className='w-full border border-pink-600 rounded-lg px-3 py-2 outline-none' name='stock' 
            placeholder='Enter Product stock' required  value={stock} onChange={(e)=>setStock(e.target.value)}/>
            </div> */}
